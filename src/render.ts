import { AssetKey, assets, sizes } from "./assets";
...
export let startShake = (duration: number, intensity: number) => {
 ...
 */
export let beginShake = (dt: number) => {
